...
<body>
	...
	<div class="navbar" style="background-color: #002347">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href="{{url('admin-view-dashboard')}}"><span>Admin Panel</span></a>
					...
					<ul class="nav pull-right">
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu">
								...
								<li><a href="{{url('/')}}"><i class="halflings-icon off"></i> Logout</a></li>
							</ul>
						</li>
			...
			<div id="sidebar-left" class="span2" style="background-color: #002347"> 
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a href="{{url('admin-view-dashboard')}}"><i class="icon-bar-chart"></i><span class="hidden-tablet">Dashboard</span></a></li>
						
						<li><a href="{{url('admin-view-user')}}"><i class="icon-bar-chart"></i><span class="hidden-tablet">User</span></a></li>
	...
	<footer style="background-color: #002347">
		...
		<p>
			<span style="text-align:left;float:left">&copy; 2021 <a href="#" alt="Bootstrap Themes" style="color: white" target="_blank">Cooking Portal</a></span>
